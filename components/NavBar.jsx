...
const NavBar = () => {
  ...
  return (
    <div className="fixed h-14 w-full flex flex-nowrap items-center p-4 bg-[#0e0e10] mb-[2px] z-10">
      ...
      <div className="flex grow items-center justify-start">
        ...
        <div className="p-4">
          <Menu as="div" className="relative text-left">
            ...
            >
              <Menu.Items className="origin-top-right absolute left-0 mt-2 w-66 rounded-md shadow-lg bg-[#0e0e10] ring-1 ring-white ring-opacity-5 focus:outline-none">
                <div className="py-1">
                  <Menu.Item>
                    {({ active }) => (
                      <a
      ...
      {/* Middle Side */}
      <div className="hidden md:flex grow-[2] items-center">
      ...
      <div
        className={
          nav
            ...
            : "fixed top-0 left-[-100%] w-full h-screen bg-[#0e0e10] flex justify-center items-center ease-in duration-300"
        }
      >
        <ul className="text-center">
          ...
          <li onClick={() => setNav(false)} className="p-4 text-3xl font-bold">
            <Link href="/#categores">Top Categories </Link>
          </li>
          <li onClick={() => setNav(false)} className="p-4 text-3xl font-bold">
